    ...
    <div className="space-y-7 sm:space-y-8">
      <div className="border-b border-slate-200/80 pb-6 dark:border-slate-700/60">
        ...
        <p className="mt-2 max-w-3xl text-[0.9375rem] leading-relaxed text-slate-600 dark:text-slate-400">
          Select a location on the map and fill in warehouse details to provision a new warehouse login.
        </p>
      </div>
          ...
          <div className="space-y-5 p-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                disabled={isLoadingAddress}
                className={`w-full rounded-xl border px-3 py-2.5 text-sm shadow-sm transition-colors resize-none ${
                  isLoadingAddress
                    ? disabledInputClass
